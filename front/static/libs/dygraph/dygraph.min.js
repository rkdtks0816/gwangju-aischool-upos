/*! @license Copyright 2017 Dan Vanderkam (danvdk@gmail.com) MIT-licensed (http://opensource.org/licenses/MIT) */ ! function (t) {
  ...
  return function t(e, a, i) {
    ...
    6: [function (t, e, a) {
      ...
      var i = function () {},
        n = i;
      n.X = 0, n.Y = 1, n.EXTRAS = 2, n.prototype.extractSeries = function (t, e, a) {}, n.prototype.seriesToPoints = function (t, e, a) {
        ...
        if (o)
          ...
          if (i("logscale")) {
            ...
            var g = n.binarySearch(t, d, 1),
              f = n.binarySearch(e, d, -1); - 1 == g && (g = 0), -1 == f && (f = d.length - 1);
            var _ = null;
            if (f - g >= u / 4) {
              for (var v = f; v >= g; v--) {
                var y = d[v],
      ...
      (function (i) {
        ...
        Q.NAME = "Dygraph", Q.VERSION = "2.1.0", Q.DEFAULT_ROLL_PERIOD = 1, Q.DEFAULT_WIDTH = 480, Q.DEFAULT_HEIGHT = 320, Q.ANIMATION_STEPS = 12, Q.ANIMATION_DURATION = 200, Q.Plotters = d.default._Plotters, Q.addedAnnotationCSS = !1, Q.prototype.__init__ = function (t, e, a) {
          ...
          var e, a, i = [],
            ...
            r = t.split(n || "\n"),
            o = this.getStringOption("delimiter"); - 1 == r[0].indexOf(o) && r[0].indexOf("\t") >= 0 && (o = "\t");
          var s = 0;
      ...
      o.prototype.select = function (t) {
        ...
        if ("follow" === n) {
          var r = t.dygraph.plotter_.area,
            ...
            h = a[0].x * r.w + 25,
            u = a[0].y * r.h - 50;
          h + s + 1 > r.w && (h = h - 50 - s - (l - r.x)), t.dygraph.graphDiv.appendChild(this.legend_div_), this.legend_div_.style.left = l + h + "px", this.legend_div_.style.top = u + "px"
        }
        ...
        for (var n = 0; n < t.series.length; n++) {
          ...
          if (r.isVisible) {
            i && (a += "<br>");
            a += "<span" + (r.isHighlighted ? ' class="highlight"' : "") + "> <b><span style='color: " + r.color + ";'>" + r.labelHTML + "</span></b>:&#160;<span class='fw-500'>" + r.yHTML + "</span></span>"
          }
        }
        return a
